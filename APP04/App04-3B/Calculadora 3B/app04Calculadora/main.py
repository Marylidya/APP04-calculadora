...
def main(page: ft.Page):
    ...
    page.add(ft.ElevatedButton(text="Limpiar", on_click=limpiar), alignment="center")
    ...
    ft.Column(controls=[
        ...
        ft.Row(controls=[ft.ElevatedButton(text="Limpiar", on_click=limpiar)], alignment="center")
    ])
)
